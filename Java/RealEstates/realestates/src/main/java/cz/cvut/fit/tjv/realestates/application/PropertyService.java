...
public interface PropertyService extends Service<Property, Long> {
    ...
    void addOwnerToProperty(Owner owner, Property property) throws EntityNotFoundException;
    void removeOwnerFromProperty(Owner owner, Property property) throws EntityNotFoundException, IllegalArgumentException;
}
