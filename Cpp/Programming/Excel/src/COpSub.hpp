 ...
 * */
class COpSub : public CExpression {
    public:
        /**
         * Constructor for COpSub which inherits from CExpression class
         ...
         * */
        COpSub(const std::map<CPos, std::pair<ASTnode, std::vector<CPos>>> &data, ASTnode lhs, ASTnode rhs)
        ...
        /**
         * Creates a deep copy of COpSub instance
         * @param[in] map - new map to which new instance will point to
         * @returns a new std::unique_ptr to COpSub
         * */
