 ...
 * */
class COpDivision : public CExpression {
    public:
        /**
         * Constructor for COpDivision which inherits from CExpression class
         ...
         * */
        COpDivision(const std::map<CPos, std::pair<ASTnode, std::vector<CPos>>> &data, ASTnode lhs, ASTnode rhs)
         ...
         *  std::monostate is returned even when denominator is equal to 0
         * */
        ...
        /**
         * Creates a deep copy of COpDivision instance
         * @param[in] map - new map to which new instance will point to
         * @returns a new std::unique_ptr to COpDivision
         * */
