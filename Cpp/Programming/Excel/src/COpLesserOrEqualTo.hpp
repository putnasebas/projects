 ...
 * */
class COpLesserOrEqualTo : public CExpression {
    public:
        /**
          ...
          * */
        COpLesserOrEqualTo(const std::map<CPos, std::pair<ASTnode, std::vector<CPos>>> &data, ASTnode lhs, ASTnode rhs)
        ...
        /**
         * Creates a deep copy of COpLesserOrEqualTo instance
         * @param[in] map - new map to which new instance will point to
         * @returns a new std::unique_ptr to COpLesserOrEqualTo
         * */
