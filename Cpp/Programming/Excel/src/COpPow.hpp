 ...
 * */
class COpPow : public CExpression {
    public:
        /**
         * Constructor for COpPow which inherits from CExpression class
         ...
         * */
        COpPow(const std::map<CPos, std::pair<ASTnode, std::vector<CPos>>> &data, ASTnode lhs, ASTnode rhs)
        ...
        /**
         * Creates a deep copy of COpPow instance
         * @param[in] map - new map to which new instance will point to
         * @returns a new std::unique_ptr to COpPow
         * */
