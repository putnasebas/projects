 ...
 * */
class COpGreaterOrEqualTo : public CExpression {
    public:
        /**
         * Constructor for COpGreaterOrEqualTo which inherits from CExpression class
         ...
         * */
        COpGreaterOrEqualTo(const std::map<CPos, std::pair<ASTnode, std::vector<CPos>>> &data, ASTnode lhs, ASTnode rhs)
